...
func main() {
  flag0 := []byte{0x66, 0x6C, 0x61, 0x67, 0x7B, 0x55, 0x75, 0x75, 0x6F, 0x49, 0x37, 0x41, 0x53, 0x39, 0x6B, 0x39, 0x6E, 0x30, 0x69, 0x4B, 0x6F, 0x37, 0x6B, 0x70, 0x54, 0x4E, 0x41, 0x6E, 0x58, 0x74, 0x66, 0x36, 0x4C, 0x78, 0x55, 0x58, 0x58, 0x7D}
  ...
  flag5 := []byte{0x66, 0x6C, 0x61, 0x67, 0x7B, 0x55, 0x75, 0x74, 0x6F, 0x49, 0x37, 0x41, 0x53, 0x39, 0x6C, 0x39, 0x6E, 0x30, 0x68, 0x4B, 0x6F, 0x37, 0x6B, 0x70, 0x54, 0x4E, 0x41, 0x6E, 0x58, 0x74, 0x66, 0x36, 0x4C, 0x78, 0x55, 0x58, 0x58, 0x7D}
  ...
  flag7 := []byte{0x66, 0x6C, 0x61, 0x67, 0x7B, 0x55, 0x75, 0x74, 0x6F, 0x49, 0x37, 0x41, 0x53, 0x39, 0x6B, 0x39, 0x6E, 0x30, 0x68, 0x4B, 0x6F, 0x37, 0x6B, 0x70, 0x54, 0x4E, 0x41, 0x6E, 0x58, 0x74, 0x66, 0x36, 0x4C, 0x78, 0x55, 0x58, 0x58, 0x7D}
  ...
  if len(os.Args) != 2 {
    ...
    for ind, _ := range flag0 {
      fmt.Printf(string(flag0[ind]))
    }
    fmt.Printf("\n")
  } else {
    fmt.Println("Printing random flag:")
    for ind, _ := range flag3 {
      fmt.Printf(string(flag3[ind]))
    }
    fmt.Printf("\n")
  }
}
